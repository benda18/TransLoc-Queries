...
puts "##{var1}	#{arr1.mean.round(0)}"
puts "##{var2}	#{arr2.mean.round(0)}"
puts "##{var3}	#{arr3.mean.round(0)}"
puts "##{var4}	#{arr4.mean.round(0)}"
puts "##{var5}	#{arr5.mean.round(0)}"
puts "##{var6}	#{arr6.mean.round(0)}"
puts "##{var7}	#{arr7.mean.round(0)}"
puts "##{var7L}	#{arr7L.mean.round(0)}"
puts "##{var8}	#{arr8.mean.round(0)}"
puts "##{var10}	#{arr10.mean.round(0)}"
puts "##{var11}	#{arr11.mean.round(0)}"
puts "##{var11L}	#{arr11L.mean.round(0)}"
puts "##{var12}	#{arr12.mean.round(0)}"
puts "##{var13}	#{arr13.mean.round(0)}"
puts "##{var15}	#{arr15.mean.round(0)}"
puts "##{var15L}	#{arr15L.mean.round(0)}"
puts "##{var16}	#{arr16.mean.round(0)}"
puts "##{var18}	#{arr18.mean.round(0)}"
puts "##{var19}	#{arr19.mean.round(0)}"
puts "##{var21}	#{arr21.mean.round(0)}"
puts "##{var22}	#{arr22.mean.round(0)}"
puts "##{var23L}	#{arr23L.mean.round(0)}"
puts "##{var24L}	#{arr24L.mean.round(0)}"
puts "##{var25L}	#{arr25L.mean.round(0)}"
#puts "##{var31}	#{arr31.mean.round(0)}"
puts "##{var40X}	#{arr40X.mean.round(0)}"
puts "##{var54L}	#{arr54L.mean.round(0)}"
puts "##{var55X}	#{arr55X.mean.round(0)}"
puts "##{var70X}	#{arr70X.mean.round(0)}"
#puts "##{var900}	#{arr900.mean.round(0)}"
puts "##{varrline}	#{arrrline.mean.round(0)}"
#puts "##{varwfl}	#{arrwfl.mean.round(0)}"
