# A ruby script that post-processes real-time next bus arrival data
# to create a calendar chart showing average wait in minutes for each 
# bus stop as a calendar date during a period of time.  You are able 
# to query specific stops and routes in the #INPUTS section of the 
# code below
...
# The output AvgStopWait_Cal_Infographic_CAT.html will be created in 
